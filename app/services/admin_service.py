...
class AdminService:
    ...
    def _serialize_user(self, user: Any) -> dict[str, str | bool]:
        return {
    ...
    def _serialize_region(self, region: Any) -> dict[str, Any]:
        return {
            "region_id": region.id,
    ...
    def update_user_role(self, username: str, role: str) -> dict[str, str | bool]:
    ...
    def delete_test_users(
        ...
        deleted_usernames = self.user_repository.delete_by_prefix_excluding(
            prefix=prefix,
